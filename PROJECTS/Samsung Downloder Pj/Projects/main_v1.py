...
class Downloader(TkinterDnD.Tk):
    ...
    def widget(self):
        ...
        self.file_drop_entry.grid(row=0, column=1, padx=5, pady=5)
        self.add_placeholder(self.file_drop_entry, "Drag Your File Here")

        # Samsung Id Entry
        self.Samsung_id = ttk.Entry(self.frame, width=50)
        self.Samsung_id.grid(row=1, column=1, padx=5, pady=5)
        ...
        #Set Button
        self.set_button = ttk.Button(self.frame, text="Set", command=self.set)
        self.set_button.grid(row=7, column=1, padx=5, pady=5)
    ...
    def process_file(self, file_path):
        ...
        with open(file_path, "rb") as file:
            ...
            if samsung_index != -1:
                ...
                self.Samsung_id.delete(0, 'end')
                self.Samsung_id.insert(0, samsung_id)
                self.download_button["state"] = "normal"
            else:
                messagebox.showwarning("Samsung ID not found in the file.")
                return
    # Directly open Save File When Downloaded is Complete Code
    def open_file_explorer(self,path):
        ...
        if  system_plateform =="Windows":
            ...
            os.startfile(path)
        elif  system_plateform =="Mac":
            os.startfile(path)
        else:
            messagebox.showerror("Invalid Os")
    # Download Button all Function Exclude Code
    def download(self):
        ...
        for attempt in range(max_retries):
                    ...
                    if version:
                        ...
                        if os.path.exists(file_path):
                            ...
                            if file_size < expected_size:
                                ...
                                self.open_file_explorer(save_location)
                                break
                            else:
            ...
            if attempt < max_retries - 1:
                ...
                break
    # Detect Drag ANd Drop File COde
